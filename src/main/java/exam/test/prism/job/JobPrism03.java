...
import exam.test.prism.task.TaskPrismReasearchDetail;
import exam.test.prism.task.TaskPrismReasearchFile;
...
public class JobPrism03 {
	...
	@Autowired
	private TaskPrismReasearchFile taskPrismReasearchFile;
	...
	private final String JOB_ID     = "JobPrism03";
	private final String STEP_ID_01 = "taskJobParameterConfig";
	private final String STEP_ID_02 = "taskPrismReasearchFile";
...
//				.next(stepSample())
	...
	@JobScope
	public Step taskPrismReasearchFile() {
		return stepBuilderFactory.get(STEP_ID_02)
				.tasklet(taskPrismReasearchFile.taskPrismReasearchFile(jobparametersMap))
				.build();
	}
