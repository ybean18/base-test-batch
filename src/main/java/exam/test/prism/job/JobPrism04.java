...
import exam.test.prism.task.TaskPrismReasearchFileData;
...
public class JobPrism04 {
	...
	@Autowired
	private TaskPrismReasearchFileData taskPrismReasearchFileData;
	...
	private final String JOB_ID     = "JobPrism04";
	private final String STEP_ID_01 = "taskJobParameterConfig";
	private final String STEP_ID_02 = "taskPrismReasearchFileData";
...
//				.next(stepSample())
	...
	public Step taskPrismReasearchFile() {
		return stepBuilderFactory.get(STEP_ID_02)
				.tasklet(taskPrismReasearchFileData.taskPrismReasearchFileData(jobparametersMap))
				.build();
	}
