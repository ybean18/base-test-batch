...
public class JobPrism02 {
	...
	@Autowired
	private TaskPrismReasearchDetail taskPrismReasearchDetail;
	...
	private final String JOB_ID     = "JobPrism02";
	private final String STEP_ID_01 = "taskJobParameterConfig";
	private final String STEP_ID_02 = "taskPrismReasearchDetail";
...
//				.next(stepSample())
	...
	public Step taskPrismReasearchFile() {
		return stepBuilderFactory.get(STEP_ID_02)
				.tasklet(taskPrismReasearchDetail.taskPrismReasearchDetail(jobparametersMap))
				.build();
	}
